...
@NgModule({
  declarations: [ActivityDrawerComponent, ExploreMainDrawerComponent, MessengerDrawerComponent],
  imports: [CommonModule, InlineSVGModule, RouterModule, ChatInnerModule],
  exports: [ActivityDrawerComponent, ExploreMainDrawerComponent, MessengerDrawerComponent],
})
