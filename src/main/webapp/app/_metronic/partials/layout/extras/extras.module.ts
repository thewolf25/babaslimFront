...
@NgModule({
  declarations: [NotificationsInnerComponent, QuickLinksInnerComponent, UserInnerComponent, LayoutScrollTopComponent],
  imports: [CommonModule, InlineSVGModule, RouterModule, TranslationModule],
  exports: [NotificationsInnerComponent, QuickLinksInnerComponent, UserInnerComponent, LayoutScrollTopComponent],
})
